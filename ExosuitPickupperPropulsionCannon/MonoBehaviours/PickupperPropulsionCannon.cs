    ...
    public class PickupperPropulsionCannon : MonoBehaviour
    {
        ...
        void Pickup()
        {
            if (_activeTarget is not null)
            {
                ...
                if (pickupable is not null && pickupable.isPickupable && _exosuit.storageContainer.container.HasRoomFor(pickupable))
                {
                    ...
                    _exosuit.storageContainer.container.UnsafeAdd(item);
